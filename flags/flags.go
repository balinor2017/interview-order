...
const CacheTrackerOrderPrefix = "CacheTrackerOrder_%d"
const CacheOrderPrefix = "ORDER_%d"
const CacheOrderTripPrefix = "ORDER_TRIP_%d"
const CachePassengerPrefix = "PASSENGER_%d"
const CacheDriverPrefix = "DRIVER_%d"
...
const SendingNotification = "send_notification"
